...
export default class Donut extends React.Component<IDonutProps> {
    public render(): JSX.Element {
        return (
          ...
          <circle className="donut-segment" cx="21" cy="21" r="15.91549430918954" fill="transparent" stroke={this.props.fillColor} strokeWidth="4" strokeDasharray={`${this.props.percentage} ${100 - this.props.percentage}`} strokeDashoffset="25"></circle>
